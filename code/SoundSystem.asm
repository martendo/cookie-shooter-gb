...
PRINT "SoundSystem Configuration:\n"
...
PRINT "    Code Bank: {SOUNDSYSTEM_CODE_BANK}\n"
PRINT "    WRAM Bank: {SOUNDSYSTEM_WRAM_BANK}\n"
...
IF (SOUNDSYSTEM_ENABLE_VUM == 0)
PRINT "    VU Meters: disabled\n"
ELSE
PRINT "    VU Meters: ENABLED\n"
ENDC
